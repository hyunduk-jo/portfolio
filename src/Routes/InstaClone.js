...
const InstaClone = () => {
  ...
  return <>
    ...
    <Container>
      ...
      <ProjectImg src="/projectImg/instaclone/feed.jpg" text="인스타 클론" />
      <TextContainer>
      ...
      <ProjectImg src="/projectImg/instaclone/prisma.jpg" text="Prisma" />
      <TextContainer>
      ...
      <ProjectImg src="/projectImg/instaclone/signup.jpg" text="Sign Up" />
      <TextContainer>
      ...
      <ProjectImg src="/projectImg/instaclone/feed.jpg" text="Feed" />
      <TextContainer>
      ...
      <ProjectImg src="/projectImg/instaclone/searchresult.jpg" text="검색 결과" />
      <TextContainer>
      ...
      <ProjectImg src="/projectImg/instaclone/upload.jpg" text="Upload Post" />
      <TextContainer>
        <TextTitle>Profile</TextTitle>
        <Text>프로필에는 Avatar, username, fullname, follower, following, 내가 작성한 게시물이 표시된다.</Text>
      </TextContainer>
      <ProjectImg src="/projectImg/instaclone/profile.jpg" text="Profile" />
      <GitLink>
        <GitHub size="48" />
