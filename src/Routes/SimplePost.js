...
const SimplePost = () => {
  ...
  <Helmet title="Portfolio | Simple Post" />
    <Container>
      ...
      <ProjectImg src="/projectImg/simpleposting/login.jpg" text="Simple Posting" />
      <TextContainer>
      ...
      <ProjectImg src="/projectImg/simpleposting/signup.jpg" text="Sign Up" />
      <TextContainer>
      ...
      <ProjectImg src="/projectImg/simpleposting/token.jpg" text="JWT" />
      <TextContainer>
      ...
      <ProjectImg src="/projectImg/simpleposting/upload.jpg" text="Upload" />
      <TextContainer>
      ...
      <ProjectImg src="/projectImg/simpleposting/comment.jpg" text="Comment" />
      <GitLink>
        <GitHub size="48" />
